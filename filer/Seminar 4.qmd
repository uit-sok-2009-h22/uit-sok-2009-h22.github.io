...
I denne oppgaven skal vi bruke datasettet angåend priser på boliger i Taiwan  *taiwan_real_estate*.
I dette datasettet 414 hus/leiligheter med 4 variabler. Disse variablere er pris per kvadrat meter (price_twd_msq), antall butikker i nærheten (n_convenience), avstand til metro i meter (dist_to_mrt_m) og alder på bolig i tre kategorier (house_age_years)
...
For å helpe med forståelsen på hvordan endring av en variable påvirker kvadratmeterpris kan vi ta å lage en funksjon av modellen predikere prisen. Prediker hvor mye en ekstra butikke i nærheten påvirker prisen på hus/leilighet.
...
Kjør en anova test for å se om det er noe forskjell mellom noen av gruppen.
Hva er nullhypotesen og alternativs hypotesen til denne testen?
