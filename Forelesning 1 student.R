...
##### Fa oversikt over dataen ##### 

# La oss få en oversikt over datasettet
glimpse(spore_under)
str(spore_under)
# Vi ser at det er mange spørsmål om studenter og 
...
table(spore_under$`Hva synes du om UiT?`)
mean(spore_under$`Hva synes du om UiT?`)
median(spore_under$`Hva synes du om UiT?`)
